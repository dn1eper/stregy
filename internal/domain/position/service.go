...
type Service interface {
	Create(p *Position, stratexecID string) (*Position, error)
...
func (s *service) Create(p *Position, stratexecID string) (*Position, error) {
...
// 	}
// 	if stopPrice != nil {
// 		o, err := s.orderService.Create(direction, mainOrder.Size, *stopPrice, order.Stop, mainOrder.SetupTime, stratexecID)
// 		if err != nil {
// 			return nil, err
// 		}
...
// 	}
// 	if takePrice != nil {
// 		o, err := s.orderService.Create(direction, mainOrder.Size, *takePrice, order.Stop, mainOrder.SetupTime, stratexecID)
// 		if err != nil {
// 			return nil, err
// 		}
